...
setup(
    name='openbmp-python-api-message',
    version='1.0',
    ...
    package_dir={
        'openbmp': 'src/openbmp',
        'openbmp.api': 'src/openbmp/api',
        'openbmp.api.parsed': 'src/openbmp/api/parsed',
        'openbmp.api.parsed.message': 'src/openbmp/api/parsed/message'
    },
    zip_safe=False
)
